import{g as d}from"./userStorage-N8JIWYZF.js";import{a as g,d as l}from"./apiHelpers-CaMtOk0F.js";import"./main-Cd0e_wCj.js";const a=[];function L(){const e=d();if(!e){window.showToast("❌ 사용자 정보가 없습니다.",3e3,"error");return}async function o(){return(await(await g(`/model_admin_menu?userId=${e==null?void 0:e.userId}&func=get-all-menu`)).json()).items}function n(t){const s=document.getElementById("menu-table-body");s&&(a.length=0,s.innerHTML=t.map(r=>{var c;const m=((c=r.image)==null?void 0:c.split("\\").pop())??"",w=encodeURIComponent(m),h=`https://model-narrow-road.s3.ap-northeast-2.amazonaws.com/model/${r.userId}/${w}`;return`
      <tr>
        <td>${r.no}</td>

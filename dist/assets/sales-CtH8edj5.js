import{h as R}from"./html2canvas.esm-BfYXEYrK.js";import{a as L}from"./main-BIItqQfl.js";let x=[],v=[],C=0,r=1;const T=10;let g="transaction",f="",m="",D="all";function st(){console.log("✅ sales.ts 로드됨"),U(),j(),F(),K(),et(),g="transaction",N(),h(),G()}function U(){document.querySelectorAll('input[name="sales-type"]').forEach((e,t)=>{e.addEventListener("change",o=>{o.target.checked&&(g=t===0?"transaction":"product",r=1,J(),g==="product"&&(N(),f="",m=""),h())})})}function j(){const n=document.querySelector('input[type="date"]:first-of-type'),e=document.querySelector('input[type="date"]:last-of-type'),t=document.querySelector(".btn-i.search"),o=document.querySelector(".btn-i.reset");n&&n.addEventListener("change",a=>{f=a.target.value}),e&&e.addEventListener("change",a=>{m=a.target.value}),t&&t.addEventListener("click",()=>{z()&&(r=1,h())}),o&&o.addEventListener("click",()=>{X(),r=1,h()})}function F(){document.querySelectorAll('input[name="detail-period"]').forEach((e,t)=>{e.addEventListener("change",o=>{o.target.checked&&(_(t),r=1,h())})})}function _(n){const e=document.querySelector('input[type="date"]:first-of-type'),t=document.querySelector('input[type="date"]:last-of-type');if(!e||!t)return;const o=new Date;let a="",s="";switch(n){case 0:a="",s="";break;case 1:a=b(o),s=b(o);break;case 2:const d=new Date(o);d.setDate(o.getDate()-1),a=b(d),s=b(d);break;case 3:const c=new Date(o.getFullYear(),o.getMonth(),1),u=new Date(o.getFullYear(),o.getMonth()+1,0);a=b(c),s=b(u);break;case 4:const i=new Date(o.getFullYear(),o.getMonth()-1,1),l=new Date(o.getFullYear(),o.getMonth(),0);a=b(i),s=b(l);break}e.value=a,t.value=s,f=a,m=s}function J(){const n=document.getElementById("table-header"),e=document.querySelector(".tableArea"),t=document.getElementById("date-search-section"),o=document.getElementById("detail-settings-section");if(!n||!e){console.error("테이블 요소를 찾을 수 없습니다.");return}g==="transaction"?(n.innerHTML=`
      <th>순서</th>
      <th>일자</th>
      <th>상품</th>
      <th>가격</th>

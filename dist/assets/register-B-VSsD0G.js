import{h as b}from"./main-CDPA_epI.js";function h(){console.log("✅ register.ts 로드됨");const r=document.getElementById("register-form");if(!r){console.error("❌ 회원가입 폼을 찾을 수 없음");return}r.addEventListener("submit",async t=>{t.preventDefault();const e=document.getElementById("adminId").value.trim(),o=document.getElementById("password").value.trim(),a=document.getElementById("number").value.trim(),c=document.getElementById("confirmPassword").value.trim(),l=document.getElementById("privacyAgree").checked,i=document.getElementById("kakaoAgree").checked,u=`
      ...
      `}};function s(t){var e,o;(e=document.getElementById("modal-backdrop"))==null||e.classList.remove("hidden"),(o=document.getElementById("modal-content"))==null||o.classList.remove("hidden"),document.getElementById("modal-title").innerText=d[t].title,document.getElementById("modal-body").innerHTML=d[t].body}function m(){var t,e;(t=document.getElementById("modal-backdrop"))==null||t.classList.add("hidden"),(e=document.getElementById("modal-content"))==null||e.classList.add("hidden")}window.openModal=s,window.closeModal=m}export{h as initRegister};
